...
# --------------------------------------------------------------------------- #
DATA_DIR = "../scripts/val/data"
# MODEL_FOLDER = "../../model/Qwen3-1.7B-SFT-DAPO-4B-filtered"
# MODEL_FOLDER = "/ossfs/workspace/aitech_aidata/chuwei/models/Qwen/Qwen3-1.7B-Base"
