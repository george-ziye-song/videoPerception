        ...
        with torch.autocast(device_type=self.device_name, dtype=torch.bfloat16):
            ...
            if self.use_remove_padding:
                ...
                if mm_token_type_ids is not None:
                    # same unpad as the 2D position_ids case above - mm_token_type_ids is always (bsz, seqlen)
                ...
                output = self.actor_module(
                    ...
                    **multi_modal_inputs,
                    **({"mm_token_type_ids": mm_token_type_ids_rmpad} if mm_token_type_ids_rmpad is not None else {}),
                    use_cache=False,
